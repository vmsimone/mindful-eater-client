    ...
    render() {
        return (
            <div className="diet-list">
                ...
                <div 
                    onClick={() => this.changeDiet("vegetarian")}
                ...
                <div 
                    onClick={() => this.changeDiet("pescatarian")}
                ...
                <div 
                    onClick={() => this.changeDiet("glutenFree")}
